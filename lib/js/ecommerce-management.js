Vue.component("ecommerce-management", {
	template: `
		<div>
			<navbar :loggedin="loggedIn" @clear-cart="clearCart" :cartitems="cart"></navbar>
			
			<ecommerce-content :loggedin="loggedIn" :frontpageitems="frontPageItems"  @item-obj="addItemToCart" ></ecommerce-content>
